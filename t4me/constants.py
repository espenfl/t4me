...
zero = np.finfo(dtype=float).tiny
inf = np.inf

rbf_functions = ["multiquadric", "inverse_multiquadric",
                 "gaussian", "linear",
                 "cubic", "quintic",
                 "thin_plate"]

einspline_boundary_cond = ["periodic",
                           "flat", "natural", "antiperiodic"]

wildmagic_methods = ["trilinear",
                     "tricubic_exact", "tricubic_bspline", "akima"]

interp1d_methods = ["linear", "nearest",
